package com.amit.search.viewmodel

import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.amit.search.model.FlickrPhotoService
import com.amit.search.model.FlickrPhotoServiceBuilder
import com.amit.search.model.FlickrResponse
...
class SearchViewModel : ViewModel() {
    ...
    private fun fetchFlickrResponse(query: String) {
        ...
        val response = flickrPhotoService.getSearchResult(query, "342e6be4234ca609b3d248a5500475bd")
